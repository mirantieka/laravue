                            ...
                            <div class="card-body">
                                <div class="chart-container ov-h">
                                    <div id="flotPie1" class="float-chart">
                                        <input type="hidden" name="pending" id="pending" value="{{$pie['pending']}}">
                                        <input type="hidden" name="failed" id="failed" value="{{$pie['failed']}}">
                                        <input type="hidden" name="success" id="success" value="{{$pie['success']}}">
                                    </div>
                                </div>
                            </div>
                        </div><!-- /.card -->
...
<script>
    jQuery(document).ready(function($) {
        ...
        // Pie chart flotPie1
        var pending_val = $("#pending").val();
        var failed_val = $("#failed").val();
        var success_val = $("#success").val();
        var piedata = [{
                label: "Pending",
                data: pending_val,
                color: '#5c6bc0'
