    ...
    <div class="card-body card-block">
        <form action="{{ route('products.update', $item->id) }}" method="post">
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="" cols="20" rows="10" class="ckeditor form-control @error('description') is-invalid @enderror">{{ old('description') ? old('description') : $item->description }}</textarea>
